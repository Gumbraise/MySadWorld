...
class NativeOpenStreetMapController implements MapController, MapListener {
    ...
    static /* synthetic */ class C058314 {

        /* renamed from: $SwitchMap$org$osmdroid$views$overlay$ScaleBarOverlay$UnitsOfMeasure */
        static final /* synthetic */ int[] f48xde2f8ad0 = new int[UnitsOfMeasure.values().length];

        static {
            try {
                f48xde2f8ad0[UnitsOfMeasure.imperial.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f48xde2f8ad0[UnitsOfMeasure.metric.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            f46xbe9cb241 = new int[MapScaleUnits.values().length];
            try {
                f46xbe9cb241[MapScaleUnits.METRIC.ordinal()] = 1;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f46xbe9cb241[MapScaleUnits.IMPERIAL.ordinal()] = 2;
            } catch (NoSuchFieldError e4) {
            }
            f47x5f87d236 = new int[MapType.values().length];
            try {
                f47x5f87d236[MapType.ROADS.ordinal()] = 1;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f47x5f87d236[MapType.AERIAL.ordinal()] = 2;
            } catch (NoSuchFieldError e6) {
            }
            try {
                f47x5f87d236[MapType.TERRAIN.ordinal()] = 3;
            } catch (NoSuchFieldError e7) {
            }
            try {
                f47x5f87d236[MapType.UNKNOWN.ordinal()] = 4;
    ...
    public MapScaleUnits getScaleUnits() {
        switch (C058314.f48xde2f8ad0[this.scaleBar.getUnitsOfMeasure().ordinal()]) {
            case 1:
