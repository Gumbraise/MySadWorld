...
class NativeOpenStreetMapController implements MapFactory.MapController, MapListener {
    ...
    public void showInfobox(MapFactory.MapFeature feature) {
        this.featureOverlays.get(feature).showInfoWindow();
    }
    ...
    static /* synthetic */ class AnonymousClass14 {
        ...
        static {
            ...
            $SwitchMap$com$google$appinventor$components$runtime$util$MapFactory$MapType = new int[MapFactory.MapType.values().length];
            try {
                $SwitchMap$com$google$appinventor$components$runtime$util$MapFactory$MapType[MapFactory.MapType.ROADS.ordinal()] = 1;
            } catch (NoSuchFieldError e5) {
            }
            try {
                $SwitchMap$com$google$appinventor$components$runtime$util$MapFactory$MapType[MapFactory.MapType.AERIAL.ordinal()] = 2;
            } catch (NoSuchFieldError e6) {
            }
            try {
                $SwitchMap$com$google$appinventor$components$runtime$util$MapFactory$MapType[MapFactory.MapType.TERRAIN.ordinal()] = 3;
            } catch (NoSuchFieldError e7) {
            }
            try {
                $SwitchMap$com$google$appinventor$components$runtime$util$MapFactory$MapType[MapFactory.MapType.UNKNOWN.ordinal()] = 4;
